...
Feature: As a user,
  ...
  Scenario: User should login successfully with correct email and password
    ...
    And I enter "nishant111@gmail.com" email and "ajay@123" password for login
    And I click on button "Login"
    Then I should see the text "Logged in as " "nishant"
...
#    Then I should see the account deleted message "ACCOUNT DELETED!"
  ...
  Scenario: User should login successfully with correct email and password
    Then I should see the login page text "Login to your account"
    And I enter "nishant221@gmail.com" email and "ajay@123" password for login
    And I click on button "Login"
